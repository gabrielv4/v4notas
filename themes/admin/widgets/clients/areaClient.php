        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/clients/areaClient"); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="progressbar">
                    ...
                    <div class="progress-step progress-step-active" data-title="Empresa"></div>
                ...
                <div class="form-step">
                    ...
                    <label class="label">
                        ...
                        <label class="switch switch-danger">
                            <input class="generate_invoice" name="generate_invoice" type="checkbox" />
        ...
        <div class="dash_content_app_box">
            <form class="app_form" action="<?= url("/admin/clients/areaClient/{$client->id}"); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-step form-step-active">
                    <label class="label">
                        <span class="legend">*Nome StakeHolder:</span>
                        <input type="text" name="name_stakeholder" value="<?=$client->name_stakeholder?>" id="name_stakeholder" placeholder="Nome do StakeHolder" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Telefone StakeHolder:</span>
                        <input type="text" name="phone_stakeholder" value="<?=$client->phone_stakeholder?>" id="phone_stakeholder" class="mask-phone" placeholder="Telefone do StakeHolder" required />
                    </label>
                    ...
                    <label class="label">
                        <span class="legend">*CNPJ:</span>
                        <input type="text" name="cnpj" id="company_cnpj" value="<?=$client->cnpj?>" class="mask-cnpj" placeholder="CNPJ da empresa" required />
                    </label>
                ...
                <div class="form-step">
                    ...
                    <label class="label">
                        <span class="legend">*Dia do pagamento:</span>
                        <input type="text" name="pay_day" value="<?=$client->pay_day?>" id="pay_day" placeholder="Dia do pagamento" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Dia para receber a nota:</span>
                        <input type="text" name="invoice_day" value="<?=$client->invoice_day?>" id="invoice_day" placeholder="Coloque o dia em que o cliente receberá a nota fiscal" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Valor do Fee:</span>
                        <input type="text" name="fee_value" value="<?=$client->fee_value?>" id="fee_value" placeholder="Valor do Fee" required />
                    </label>
                    ...
                    <label class="label">
                        <span class="legend">*Status do cliente:</span>
                        <label class="switch switch-danger">
                ...
                <div class="form-step">
                    <label class="label">
                        <span class="legend">*CEP:</span>
                        <input type="text" name="cep" id="company_cep" value="<?=$client->cep?>" class="getcep" name="zipcode" placeholder="Digite o CEP" data-mask="00000-000" placeholder="CEP da Empresa" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Cidade:</span>
                        <input type="text" name="city" class="js-city" value="<?=$client->city?>"  id="company_city" placeholder="Ex. São Paulo" required />
                    </label>

                    <label class="label">
                        <span class="legend">*UF:</span>
                        <input type="text" name="uf" class="js-uf" value="<?=$client->uf?>"  id="company_uf"  maxlength="2" placeholder="Ex. SP" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Bairro:</span>
                        <input type="text" name="district" value="<?=$client->district?>" class="js-district" id="company_district"  placeholder="Ex. Centro" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Rua:</span>
                        <input type="text" name="street" value="<?=$client->street?>" class="js-street" id="company_street"  placeholder="Digite a rua" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Número:</span>
                        <input type="text" name="number" value="<?=$client->number?>" id="company_number" placeholder="Ex. 200" required />
                    </label>

                    <label class="label">
                        <span class="legend">*Completomento:</span>
                        <input type="text" name="complement" value="<?=$client->complement?>" class="js-complement" id="company_complement" id="complement" placeholder="Ex. ao lado da escola" />
                    </label>
                ...
                <div class="form-step">
                    ...
                    <label class="label">
                        <span class="legend">*inicio do Projeto :</span>
                        <input type="date" name="start_project" value="<?=$client->start_project?>" id="start_project" required />
                    </label>
