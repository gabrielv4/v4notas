...
function settingPrice(string $string): string
{
...
function functionary(): ?\Source\Models\Functionary
{
    return \Source\Models\AuthFunctionary::functionary();
}

function client(): ?\Source\Models\Client
{
    return \Source\Models\AuthClient::client();
}
 ...
 * @return string
 */
function theme(string $path = null, string $theme = CONF_VIEW_CLIENT): string
{
    if (strpos($_SERVER['HTTP_HOST'], "localhost")) {
        if ($path) {
